...
<div style="background-color:#dddddd;padding:4% 4% 4% 4% " class="wp-block-wec-woo-email-blocks"><div style="width:600px;height:undefinedpx;min-height:100px;margin:auto;background-color:#ffffff;border:0px solid undefined;max-width:100%;background-image:url();background-size:cover;border-radius:0px;font-family:Lato, sans-serif"><!-- wp:wec/header {"padding_top":0,"padding_bottom":0,"out_bg_color":"#222222","in_bg_color":"#222222","content":"Home &nbsp;&nbsp;&nbsp;Shop &nbsp;&nbsp;&nbsp;Services &nbsp;&nbsp;&nbsp;About","alignment":"right","text_color":"#ffffff","mediaURL":"%%domain%%/woo-custom-email-blocks/assets/img/sample-logo.png","mediaID":1} -->
        ...
        <div style="padding:0% 0% 4% 0% " class="wp-block-wec-inner-block"><div style="width:undefinedpx;height:undefinedpx;min-height:100px;margin:auto;border:0px solid undefined;max-width:100%;background-image:url(%%domain%%/woo-custom-email-blocks/assets/img/sample-background.jpg);background-size:cover;border-radius:0px"><!-- wp:wec/text {"content":"New Account","alignment":"center","text_color":"#ffffff","font_size":30} -->
                <div style="padding:4% 4% 4% 4% " class="wp-block-wec-text"><div style="width:undefinedpx;height:undefinedpx;margin:auto;text-align:center;border:0px solid undefined;max-width:100%;color:#ffffff;font-size:30px;line-height:1.5;border-radius:0px;opacity:1;padding:0% 0">New Account</div></div>
                <!-- /wp:wec/text -->

                <!-- wp:wec/text {"content":"Hello, {customer_name}! ","text_color":"#ffffff"} -->
                <div style="padding:4% 4% 4% 4% " class="wp-block-wec-text"><div style="width:undefinedpx;height:undefinedpx;margin:auto;border:0px solid undefined;max-width:100%;color:#ffffff;font-size:14px;line-height:1.5;border-radius:0px;opacity:1;padding:0% 0">Hello, {customer_name}! </div></div>
                <!-- /wp:wec/text -->

                <!-- wp:wec/text {"padding_top":0,"content":"Thanks for creating an account on {site_title}. As a reminder, the username you chose is {customer_name}. You can access your account area to view orders, change your password, and more at: {account_page}","text_color":"#ffffff"} -->
                <div style="padding:0% 4% 4% 4% " class="wp-block-wec-text"><div style="width:undefinedpx;height:undefinedpx;margin:auto;border:0px solid undefined;max-width:100%;color:#ffffff;font-size:14px;line-height:1.5;border-radius:0px;opacity:1;padding:0% 0">Thanks for creating an account on {site_title}. As a reminder, the username you chose is {customer_name}. You can access your account area to view orders, change your password, and more at: {account_page}</div></div>
                <!-- /wp:wec/text -->

                <!-- wp:wec/text {"padding_top":0,"content":"Username: {customer_name}","text_color":"#ffffff"} -->
                <div style="padding:0% 4% 4% 4% " class="wp-block-wec-text"><div style="width:undefinedpx;height:undefinedpx;margin:auto;border:0px solid undefined;max-width:100%;color:#ffffff;font-size:14px;line-height:1.5;border-radius:0px;opacity:1;padding:0% 0">Username: {customer_name}</div></div>
                <!-- /wp:wec/text -->

                <!-- wp:wec/text {"padding_top":0,"content":"Your password has been automatically generated: {new_password}","text_color":"#ffffff"} -->
                <div style="padding:0% 4% 4% 4% " class="wp-block-wec-text"><div style="width:undefinedpx;height:undefinedpx;margin:auto;border:0px solid undefined;max-width:100%;color:#ffffff;font-size:14px;line-height:1.5;border-radius:0px;opacity:1;padding:0% 0">Your password has been automatically generated: {new_password}</div></div>
                <!-- /wp:wec/text -->

                <!-- wp:wec/text {"padding_top":0,"content":"We look forward to seeing you soon.","text_color":"#ffffff"} -->
                <div style="padding:0% 4% 4% 4% " class="wp-block-wec-text"><div style="width:undefinedpx;height:undefinedpx;margin:auto;border:0px solid undefined;max-width:100%;color:#ffffff;font-size:14px;line-height:1.5;border-radius:0px;opacity:1;padding:0% 0">We look forward to seeing you soon.</div></div>
                <!-- /wp:wec/text --></div></div>
        <!-- /wp:wec/inner-block -->

        <!-- wp:wec/text {"line_height":25,"padding_bottom":0,"in_bg_color":"#fdab24","content":"MAY BE YOU LIKE","alignment":"center","text_color":"#ffffff","font_size":18} -->
        <div style="padding:4% 4% 0% 4% " class="wp-block-wec-text"><div style="width:undefinedpx;height:undefinedpx;margin:auto;background-color:#fdab24;text-align:center;border:0px solid undefined;max-width:100%;color:#ffffff;font-size:18px;line-height:2.5;border-radius:0px;opacity:1;padding:0% 0">MAY BE YOU LIKE</div></div>
        <!-- /wp:wec/text -->
