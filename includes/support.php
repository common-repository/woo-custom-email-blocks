...
new VillaTheme_Support(
	array(
		'support'   => 'https://wordpress.org/support/plugin/woo-custom-email-blocks/',
		'docs'      => 'http://docs.villatheme.com/?item=woo-custom-email-blocks',
		'review'    => 'https://wordpress.org/support/plugin/woo-custom-email-blocks/reviews/?rate=5#rate-response',
		'pro_url'   => '',
		'css'       => VI_WEC_CSS,
		'image'     => VI_WEC_IMAGES,
		'slug'      => 'woo-custom-email-blocks',
		'menu_slug' => 'woo-custom-email-blocks',
		'version'   => VI_WCEB_VERSION
	)
);