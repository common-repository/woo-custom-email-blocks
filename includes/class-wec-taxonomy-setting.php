...
if ( ! class_exists( 'WEC_Taxonomy_Radio' ) ) {
	/**
	...
	class WEC_Taxonomy_Radio {
		...
		public function add_radio_box() {
			...
			foreach ( $this->post_types() as $key => $cpt ) {
				...
				add_meta_box(
					$this->slug . '_radio', $this->metabox_title(),
					array( $this, 'radio_box' ),
		...
		public function radio_box() {
			...
			echo '<div class="meta-box-taxonomy-radio" style="margin-bottom: 5px;">
	...
	$custom_tax_mb1 = new WEC_Taxonomy_Radio( 'wec_email_template', 'wec_email_customizer' );
